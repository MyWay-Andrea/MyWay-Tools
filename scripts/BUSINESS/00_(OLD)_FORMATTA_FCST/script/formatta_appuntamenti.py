...
def main(file_app_raw):
    ...
    df = filtra_df(df)
    file_app_finale = copia_template(MASTER, nome="Appuntamenti.xlsx")
    ...
    return file_app_finale, subset

#path = Path(r"C:\Users\Stage\OneDrive - My Way S.r.l\Desktop\AUTOMAZIONI\00_FORMATTA_FCST\00_RAW_FILE\Calendario(37).csv")
