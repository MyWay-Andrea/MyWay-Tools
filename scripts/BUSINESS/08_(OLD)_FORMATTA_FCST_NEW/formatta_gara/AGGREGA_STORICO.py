...
from config import (
    carica_su_teams,
    COLONNE_CORRETTE_STORICO, PATH_STORICO_BASI_DATI, PATH_STORICO_PARQUET, PATH_STORICO_BASI_DATI
    )

from formatta_gara.formatta_gara import main as importa_gara
...
def main(file_gara, file_storico):
    ...
    carica_su_teams(df_aggregato, "Storico Gara",PATH_STORICO_BASI_DATI)
