...
from formatta_appuntamenti.formatta_appuntamenti import main as importa_appuntamenti
...
def main(file_storico, file_appuntamenti):
    ...
    # 6. Carica su teams
    carica_su_teams(df_storico_completo, "Storico Appuntamenti", PATH_STORICO_BASI_DATI)
